...
btnSubmit.addEventListener("click", (e) => {
  ...
  if (floorNumber > 99 || floorNumber < 1 || liftNumber < 1 || liftNumber > 4) {
    alert(
      "floor should be betwween 1- 99 and lift value should be between 1 - 4"
    );
  } else {
    ...
    <div class="btn__group">
      ...
      <button name="${i + 1}-down" id="floor-${
        i + 1
      }_down" class="btn">Down</button>
    </div>
    ...
    const btnDownTopFloor = document.getElementById(
      `floor-${floorNumber}_down`
    );
